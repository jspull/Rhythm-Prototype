...
namespace RhythmGameStarter
{
    ...
    public class SongItem : ScriptableObject
    {
        ...
        public static NoteName[] noteNameMapping = new NoteName[]
        {
            NoteName.C, 
            NoteName.D, 
            NoteName.E, 
        ...
        public static NoteName[] noteNameMappingExtract = new NoteName[]
        {
            NoteName.C, 
            NoteName.CSharp, 
            NoteName.D, 
        ...
        [NonSerialized]
        private List<NoteName> noteNamesCache;

        public List<NoteName> GetNoteNames()
        {
            if (noteNamesCache == null)
            {
                noteNamesCache = notes.Select(x => x.noteName).Distinct().ToList();
            }

            return noteNamesCache;
        }

        [FormerlySerializedAs("useGenetator")] public bool useGenerator;
        ...
        {
            if (useGenerator && runtimeGenerate && generator)
            {
