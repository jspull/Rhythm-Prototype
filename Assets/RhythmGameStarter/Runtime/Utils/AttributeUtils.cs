...
namespace RhythmGameStarter
{
    ...
    public class CollapsedEventDrawer : UnityEventDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            foldout.text = property.name + " (" + persistentCalls.arraySize + ")";
            int previousArraySize = persistentCalls != null ? persistentCalls.arraySize : -1;
            container.schedule.Execute(() =>
            {
                if (persistentCalls != null && persistentCalls.arraySize != previousArraySize)
                {
                    foldout.text = property.name + " (" + persistentCalls.arraySize + ")";
                    previousArraySize = persistentCalls.arraySize;
                }
            }).Every(100);  // This will execute every 100 ms. You can adjust the value as needed.

            var content = base.CreatePropertyGUI(property);
            
            foldout.tooltip = property.tooltip;
            foldout.value = false;
            foldout.Add(content);
    ...
    public class CommentAttributeDrawer : DecoratorDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI()
        {
            ...
            if (!enableHelpComment) return base.CreatePropertyGUI();
            var container = new VisualElement
            {
                style =
                {
                    backgroundColor = new StyleColor(ColorUtil.GetBackgroundColor()),
            ...
            if (commentAttribute == null) return base.CreatePropertyGUI();
            var text = new TextElement
            {
                text = commentAttribute.text,
                style =
                {
                    fontSize = 10
                }
        ...
        private void InitStyle()
        {
            ...
            backgroundColor = ColorUtil.GetBackgroundColor();
    ...
    public class TitleAttributeDrawer : DecoratorDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI()
        {
            ...
            if (titleAttribute == null) return base.CreatePropertyGUI();
