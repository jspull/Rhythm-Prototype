...
namespace RhythmGameStarter
{
    public class SequenceEditor : EditorWindow, IHasCustomMenu
    {
        ...
        private static int[] trackNumberScale = new int[] { 4, 6, 12 };
        ...
        private NoteName[] GetNoteNameMapping()
        {
            if (_stepSizeSelected != 2)
                return noteNameMapping;
            else
                return noteNameMappingExtract;
        }
        ...
        private void DrawSequencer()
        {
            ...
            {
                var targetNoteName = GetNoteNameMapping()[i];
        ...
        {
            var targetNoteName = GetNoteNameMapping()[trackIndex];
